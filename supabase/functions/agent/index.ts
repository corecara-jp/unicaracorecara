...
「理想：〔ユーザーが入力した理想の言葉〕／現状スコア〔点〕→ 〔なぜこの選択肢がギャップを埋めるか具体的な理由〕」
ユーザーが実際に入力した言葉を必ず引用し、抽象的な表現は使わないこと。
  ...
  "options": [
    {
      ...
      "summary": "ユーザーの理想と現状ギャップを踏まえた概要（80字以内）",
      "rationale": {
        "career": "理想：〔引用〕／現状〔点〕→ 転職でこのギャップを埋める理由（80字以内）",
        "life": "理想：〔引用〕／現状〔点〕→ 副業＋転職でライフ面が改善する理由（80字以内）",
        "income": "理想：〔引用〕／現状〔点〕→ 転職後の収入＋副業月〇〇万円で実現する理由（80字以内）",
        "psychology": "理想：〔引用〕→ この選択肢がなぜ心理的に最適か（80字以内）"
      },
    ...
    },
    {
      ...
      "summary": "ユーザーの理想と現状ギャップを踏まえた概要（80字以内）",
      "rationale": {
        "career": "理想：〔引用〕／現状〔点〕→ 現職のままでどこまでギャップが埋まるか（80字以内）",
        "life": "理想：〔引用〕／現状〔点〕→ 副業でライフ面が改善する理由（80字以内）",
        "income": "理想：〔引用〕／現状〔点〕→ 副業月〇〇万円で収入がどう変わるか（80字以内）",
        "psychology": "理想：〔引用〕→ 現職継続が心理的に与える影響（80字以内）"
      },
      "nextAction": "今すぐできる具体的な一歩（50字以内）",
      "risk": "この選択肢の主なリスク（50字以内）"
    },
    {
      ...
      "summary": "ユーザーの理想と現状ギャップを踏まえた概要（80字以内）",
      "rationale": {
        "career": "理想：〔引用〕／現状〔点〕→ 転職だけで解決できるギャップとできないギャップ（80字以内）",
        "life": "理想：〔引用〕／現状〔点〕→ 転職のみのライフへの影響（80字以内）",
        "income": "理想：〔引用〕／現状〔点〕→ 転職のみでの収入変化の試算（80字以内）",
        "psychology": "理想：〔引用〕→ 転職のみが心理的に与える影響（80字以内）"
      },
      "nextAction": "今すぐできる具体的な一歩（50字以内）",
      "risk": "この選択肢の主なリスク（50字以内）"
    },
    {
      ...
      "summary": "ユーザーの理想と現状ギャップを踏まえた概要（80字以内）",
      "rationale": {
        "career": "理想：〔引用〕／現状〔点〕→ 現状維持でどのリスクがあるか（80字以内）",
        "life": "理想：〔引用〕／現状〔点〕→ 現状維持がライフ面に与える影響（80字以内）",
        "income": "理想：〔引用〕／現状〔点〕→ 現状維持での収入見通し（80字以内）",
        "psychology": "理想：〔引用〕→ 現状維持が心理的に与える影響（80字以内）"
      },
      "nextAction": "今すぐできる具体的な一歩（50字以内）",
      "risk": "この選択肢の主なリスク（50字以内）"
    }
